...
# #    string.gsub!(key.to_s, REPLACEMENTS[key])
# #  end
#   string
# end
...
BASE="/Users/adolfo/Documents/Sites/w3c/_www.w3c.it/TR/3377/archivio/"
...
VIEWS.each do |group|
  ...
  files.each do |arg|
    ...
    events.each do |event|
      ...
      string = parse_news "/Users/adolfo/Documents/Sites/w3c/_www.w3c.it" + link, summary, date, group[2]
